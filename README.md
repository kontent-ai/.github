...
> ⚠ Before you start working on your project after you use the template, remove `scripts` folder and `.github/workflows/deploy.yml` file.
> If you want to make changes to the template, create a GitHub release. This triggers CD pipelines which propagates changes to all public repositories.
